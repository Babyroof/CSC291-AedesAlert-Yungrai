...
// in aedes_alert_yungrai/test/features/home/services/get_weather_forecast_use_case_test.dart.
...
class MockWeatherService extends _i1.Mock implements _i3.WeatherService {
  ...
  @override
  _i4.Future<_i2.WeatherForecastModel> getForecast(
    double? latitude,
    double? longitude,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getForecast, [latitude, longitude]),
