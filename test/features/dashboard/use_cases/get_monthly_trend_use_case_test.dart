...
void main() {
  ...
  // ── Test 1 ──────────────────────────────────────────────────────────────
  test(
    'returns exactly 3 months when Firestore has 3+ months of data',
    () async {
  ...
  // ── Test 2 ──────────────────────────────────────────────────────────────
  test('computes per-district avg correctly (two-step formula): '
  ...
  // ── Test 4 ──────────────────────────────────────────────────────────────
  test(
    'excludes future months — only includes months with real data',
    () async {
      ...
      for (final m in result) {
        expect(
          m.monthKey.compareTo(currentKey),
          lessThanOrEqualTo(0),
